...
public class Hooks {
    ...
    @After(order = 1)
    public void tearDownScenario(Scenario scenario) { //by passing Scenario in to argu it we can get info
                                                        // on each Scenario that we're running

        //System.out.println("-----> After annotation: Closing browser");

      //  System.out.println("scenario.getName() = " + scenario.getName());
      //  System.out.println("scenario.getSourceTagNames() = " + scenario.getSourceTagNames());
      //  System.out.println("scenario.isFailed() = " + scenario.isFailed());//if it fails it returns "True" else "False"
        ...
        //we attach three arguments to the scenario
            //a- screenshot we previously have created
            //b- image type ==> png
            //c- scenario name which we can get it through "scenario.getName()"

        //we usually want to take screenshot only when our scenario fails. This is just to avoid having a mess
